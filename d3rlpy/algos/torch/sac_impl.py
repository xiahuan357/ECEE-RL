...
class DiscreteSACImpl(DiscreteQFunctionMixin, TorchImplBase):
    ...
    def compute_critic_loss(
        ...
        cols = ['dob_mm', 'dob_wk', 'bfacil', 'ubfacil', 'bfacil3', 'mager41', 'mager14', 'mager9', 'restatus',
                ...
                'ume_forcp', 'ume_vac', 'rdmeth_rec', 'dmeth_rec', 'attend', 'apgar5', 'apgar5r', 'dplural', 'dlmp_mm',
                ...
                'f_urf_phyper', 'f_urf_eclamp', 'f_uob_induct', 'f_uob_tocol', 'f_uld_meconium', 'f_uld_precip',
        ...
        #                                         method_name="backdoor.propensity_score_matching",
        #                                         )
        # batch.add_additional_data('actions',[propensity_strat_estimate.value])
        # batch.actions=[propensity_strat_estimate.value]
